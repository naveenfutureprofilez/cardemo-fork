                        ...
                        <div className='col-md-6'>
                            <div className='contact-black-box cv-auto'>
                                ...
                                <div className='d-flex align-items-center mb-4'>
                                    <div className='cb-icon'><Image 
                                    placeholder="blur" quality={50}
                                    blurDataURL="local-phone-material.webp?q=1"
                                    src={getImages('local-phone-material.webp')} 
                                    alt='phone' width={24} height={24} /></div> 
                                    <div className='xs-title font-1-1em eurostile fw-bold'>512-777-1240</div>
                                </div>
                                <div className='d-flex align-items-center'>
                                    <div className='cb-icon'><Image  quality={50}
                                    blurDataURL="contact-location-icon.svg?q=1"
                                    src={getImages('contact-location-icon.svg')} 
                                    alt='location' width={24} height={24} /></div> 
